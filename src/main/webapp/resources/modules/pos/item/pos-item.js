...
(function(){
    ...
    angular.module('Asasa')
        .controller('PosItemController', ['ngTableParams','PosItemGatewayService', '$http', function(ngTableParams,posItemSrv, $http){
            ...
            posItemCtrl.cols = [
                {field: "id",title: "ItemID:",sortable: "id",filter: {id: "number"},show: true,dataType: "number"},
                {field: "itemCode",title: "itemCode ",sortable: "itemCode",filter: {itemCode: "text"},show: true,dataType: "text"},
                {field: "name",title: "Name ",sortable: "costPrice",filter: {name: "text"},show: true,dataType: "text"},
                {field: "itemDescription",title: "Description",sortable: "itemDescription",filter: {itemDescription: "number"},show: true,dataType: "text"},
                {field: "stockLevel",title: "Stock Level",sortable: "stockLevel",filter: {stockLevel: "number"},show: true,dataType: "text"}
            ...
            posItemCtrl.addPosItem = function (){
                ...
                posItem.id  = posItemCtrl.id ;
                posItem.itemCode = posItemCtrl.itemCode;
                posItem.itemUnit = posItemCtrl.itemUnit;
                posItem.stockLevel = posItemCtrl.stockLevel;
                posItem.minStockLevel = posItemCtrl.minStockLevel;
                posItem.costPrice = posItemCtrl.costPrice;
                posItem.salesPrice = posItemCtrl.salesPrice;
                posItem.location = posItemCtrl.location;
                posItem.itemDescription = posItemCtrl.itemDescription;
                posItem.supplerId = posItemCtrl.supplerId;
                posItem.itemType = posItemCtrl.itemType;
                posItem.quantity = posItemCtrl.quantity;

                posItemSrv.addPosItem(posItem).$promise.then(function(response){
                    if(response){
                        posItemCtrl.getPosItemList();
                    }
                });
