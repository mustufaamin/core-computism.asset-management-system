<div class="mainModules" >
  <div class="row-fluid">
    <div ui-sref="customer" class="span3 statbox blue" onTablet="span6" onDesktop="span3" ng-click="mainMdlsCtrl.openCustomerPanel('/customer')">
      <div class="number"><i class="icon-group"></i></div>
      <div class="widgetTitle">Customers</div>
      <%--<div class="footer">
          <a href="#" ng-click="mainMdlsCtrl.openCustomerPanel()"> Click Here <i class="icon-arrow-up"></i></a>
      </div>--%>
    </div>
    <div class="span3 statbox blue" onTablet="span6" onDesktop="span3">
      <div class="number"><i class="fa fa-calculator"></i></div>
      <div class="widgetTitle">General Ledger</div>
      <%--<div class="footer">
          <a href="#"> Click Here <i class="icon-arrow-up"></i></a>
      </div>--%>
    </div>
    <div ui-sref="ar" class="span3 statbox blue noMargin" onTablet="span6" onDesktop="span3" ng-click="mainMdlsCtrl.openArPanel()">
    ...
    <div class="span3 statbox blue" onTablet="span6" onDesktop="span3">
      <div class="number"><i class="fa fa-book"></i></div>
      <div class="widgetTitle">Account Payables</div>
      <%--<div class="footer">
          <a href="#"> Click Here <i class="icon-arrow-up"></i></a>
      </div>--%>
    </div>
  ...
  <div class="row-fluid">
    <div class="span3 statbox blue" onTablet="span6" onDesktop="span3">
      <div class="number"><i class="fa fa-money"></i></div>
      <div class="widgetTitle">Point Of Sale</div>
      <%--<div class="footer">
          <a href="#"> Click Here <i class="icon-arrow-up"></i></a>
      </div>--%>
    </div>
    <div class="span3 statbox blue" onTablet="span6" onDesktop="span3">
      ...
      <div class="widgetTitle">Inventory</div>
      <%--<div class="footer">
          <a href="#"> Click Here <i class="icon-arrow-up"></i></a>
      </div>--%>
    </div>
    ...
    <div class="widget span3 red" onTablet="span6" onDesktop="span3">
        ...
        <div class="content">
            ...
            <div class="browserStat big">
                <img src="resources/img/browser-chrome-big.png" alt="Chrome">
                <span>34%</span>
            </div>
            <div class="browserStat big">
                <img src="resources/img/browser-firefox-big.png" alt="Firefox">
                <span>34%</span>
            </div>
            <div class="browserStat">
                <img src="resources/img/browser-ie.png" alt="Internet Explorer">
                <span>34%</span>
            </div>
            <div class="browserStat">
                <img src="resources/img/browser-safari.png" alt="Safari">
                <span>34%</span>
            </div>
            <div class="browserStat">
                <img src="resources/img/browser-opera.png" alt="Opera">
                <span>34%</span>
            </div>
    ...
    <div class="box black span4" onTablet="span6" onDesktop="span4">
        ...
        <div class="box-content">
            <ul class="dashboard-list metro">
                <li class="green">
                    <a href="#">
                        <img class="avatar" alt="Dennis Ji" src="resources/img/avatar.jpg">
                    </a>
