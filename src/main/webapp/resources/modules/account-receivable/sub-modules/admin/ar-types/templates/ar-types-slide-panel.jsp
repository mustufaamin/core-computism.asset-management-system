  ...
  <div class="slidepanel" ng-show="arTypesCtrl.showPanel">
    ...
    <div class="ar-panel-content">
      ...
      <div class="at-desc cust-panel-field-div">
        ...
        <input class="cust-panel-input" ng-model="arTypesCtrl.accountTypeDesc" placeholder="Enter Account Type description..." ng-class="{disabled: arTypesCtrl.isView}"/>
      </div>
      ...
      <div class="at-code cust-panel-field-div">
        ...
        <input class="cust-panel-input" ng-model="arTypesCtrl.accountTypeCode" placeholder="Enter account type code..." ng-class="{disabled: arTypesCtrl.isView}"/>
      </div>
      <div class="company-id cust-panel-field-div">
        <label class="cust-panel-lbl">Company Id:</label>
        <input class="cust-panel-input" ng-model="arTypesCtrl.companyId" placeholder="Enter company Id..." ng-class="{disabled: arTypesCtrl.isView}"/>
      </div>
      ...
      <div class="over30Message cust-panel-field-div">
        ...
        <input class="cust-panel-input" ng-model="arTypesCtrl.over30Message" placeholder="Enter message..." ng-class="{disabled: arTypesCtrl.isView}"/>
      </div>
      <div class="over60Message cust-panel-field-div">
        <label class="cust-panel-lbl">Over 60 Message:</label>
        <input class="cust-panel-input" ng-model="arTypesCtrl.over60Message" placeholder="Enter message ..." ng-class="{disabled: arTypesCtrl.isView}"/>
      </div>
      <div class="over90Message cust-panel-field-div">
        <label class="cust-panel-lbl">Over 90 Message:</label>
        <input class="cust-panel-input" ng-model="arTypesCtrl.over90Message" placeholder="Enter message..." ng-class="{disabled: arTypesCtrl.isView}"/>
      </div>
      <div class="over120Message cust-panel-field-div">
        <label class="cust-panel-lbl">Over 120 Message:</label>
        <input class="cust-panel-input" ng-model="arTypesCtrl.over120Message" placeholder="Enter message..." ng-class="{disabled: arTypesCtrl.isView}"/>
      </div>
      <div class="leftOverAmount cust-panel-field-div">
        <label class="cust-panel-lbl">Leftover Amount:</label>
        <input type="checkbox" ng-model="arTypesCtrl.leftOverAmount" ng-class="{disabled: arTypesCtrl.isView}"/>
      </div>
      <div class="requiredStatus cust-panel-field-div">
        <label class="cust-panel-lbl">Required Status:</label>
        <input type="checkbox" ng-model="arTypesCtrl.requiredStatus" ng-class="{disabled: arTypesCtrl.isView}"/>
      </div>
    </div>
