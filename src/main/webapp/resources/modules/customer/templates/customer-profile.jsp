<div class="sub-menu" ng-show="true<%--custCtrl.customerListPanel || custCtrl.customerProfilePanel--%>">
  <ul class="menuList">
    <li class=""><a class="anime" ui-sref="customerList" ng-click="custCtrl.openCustomerList()">Customer List</a></li>
    <li class=""><a class="anime active" ui-sref="customerProfile" ng-click="custCtrl.openCustomerProfile()">Customer Profile</a></li>
  </ul>
</div>
<div class="cont-wrap">
