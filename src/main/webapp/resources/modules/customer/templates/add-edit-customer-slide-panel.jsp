<div>
  ...
  <div class="slidepanel" ng-show="false">
    <div class="cust-panel-heading">
      <label class="cust-panel-heading-lbl">Add Customer Form</label>
