...
@EnableJpaRepositories(
        ...
        basePackages = "com.core.computism.assasa.persistence.repository.inventory"
)
public class BookingPersistenceConfig {
    ...
    EntityManagerFactory entityManagerFactory() throws PropertyVetoException {
        ...
        factory.setPackagesToScan("com.core.computism.assasa.persistence.entity.inventory");
